...
export const metadata: Metadata = {
	title: 'Hasnaa Lotfy - Frontend Developer',
	description:
	...
	authors: [{ name: 'Hasnaa Lotfy' }],
	creator: 'Hasnaa Lotfy',
	openGraph: {
		title: 'Hasnaa Lotfy - Web Developer Portfolio',
		...
		siteName: 'Hasnaa Lotfy - Portfolio',
		images: [
			{
				url: '/og-image.jpg',
				width: 1200,
				height: 630,
				alt: 'Hasnaa Lotfy - Web Developer Portfolio',
			},
		],
		locale: 'en_US',
		type: 'website',
	...
	twitter: {
		...
		title: 'Hasnaa Lotfy - Web Developer',
		description: 'Passionate web developer crafting modern and engaging digital experiences. Explore my projects and web development expertise.',
